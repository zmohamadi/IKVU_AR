...
(1,'تشریحی','تشریحی','Descriptive',1,NULL,'2024-07-06 20:22:35','2024-07-06 20:22:35'),
(2,'چند گزینه ای','چند گزینه ای','Multiple choice',1,NULL,'2024-07-06 20:22:35','2024-07-06 20:22:35');
...
(1,'وضعیت فعالی','وضعیت فعالی','active status',NULL,NULL,NULL,1,NULL,'2024-07-06 20:22:35','2024-07-06 20:22:35'),
(2,'فعال','فعال','active',1,'1','theme-10',1,NULL,'2024-07-06 20:22:35','2024-07-06 20:22:35'),
(3,'غیر فعال','غیر فعال','inactive',1,'0','theme-24',1,NULL,'2024-07-06 20:22:35','2024-07-06 20:22:35'),
(4,'وضعیت پست پیامگاه','وضعیت پست پیامگاه','Message post status',NULL,NULL,NULL,1,NULL,'2024-07-18 12:55:10','2024-07-18 12:55:10'),
(5,'نیاز به بررسی','نیاز به بررسی','Need to check',4,'0','theme-23',1,NULL,'2024-07-18 12:55:10','2024-07-18 12:55:10'),
(6,'عمومی','عمومی','General',4,'1','theme-17',1,NULL,'2024-07-18 12:55:10','2024-07-18 12:55:10'),
(7,'خصوصی','خصوصی','private',4,'2','theme-10',1,NULL,'2024-07-18 12:55:10','2024-07-18 12:55:10'),
(8,'رد','رد','rejection',4,'3','theme-24',1,NULL,'2024-07-18 12:55:10','2024-07-18 12:55:10'),
(9,'نوع عملکرد پست','نوع عملکرد پست','Post function type',NULL,NULL,NULL,1,NULL,'2024-07-18 12:55:10','2024-07-18 12:55:10'),
(10,'لایک','لایک','like',9,'1','theme-24',1,NULL,'2024-07-18 12:55:10','2024-07-18 12:55:10'),
(11,'لایک نکردن','لایک نکردن','Dislike',9,'0','theme-10',1,NULL,'2024-07-18 12:55:10','2024-07-18 12:55:10');
...
(2,'کلاس آنلاین','کلاس آنلاین','online_classroom','onlineClassroom','onlineclassroom.jpg',2,1,'ابزارهای دوره‌های آموزشی ما از جمله خط سیر آموزشی، کلاس آنلاین، آرشیو کلاس آنلاین، آزمون، تکلیف، پیامگاه، ارسال و دریافت تحقیقات، و نظرسنجی، به شما امکان می‌دهند تا به راحتی به منابع آموزشی دسترسی پیدا کنید، در کلاس‌های زنده شرکت کنید، و تکالیف خود را ارسال و ارزیابی کنید. این ابزارها با هدف ارتقای تجربه آموزشی شما طراحی شده‌اند و امکانات مختلفی را برای بهبود یادگیری و ارتباط بین دانش‌آموزان و مدرسان فراهم می‌سازند.',NULL,NULL,NULL),
(3,'آرشیو کلاس آنلاین','آرشیو کلاس آنلاین','online_archives','onlineClassroomArchives','online_archives.jpg',3,1,'ابزارهای دوره‌های آموزشی ما از جمله خط سیر آموزشی، کلاس آنلاین، آرشیو کلاس آنلاین، آزمون، تکلیف، پیامگاه، ارسال و دریافت تحقیقات، و نظرسنجی، به شما امکان می‌دهند تا به راحتی به منابع آموزشی دسترسی پیدا کنید، در کلاس‌های زنده شرکت کنید، و تکالیف خود را ارسال و ارزیابی کنید. این ابزارها با هدف ارتقای تجربه آموزشی شما طراحی شده‌اند و امکانات مختلفی را برای بهبود یادگیری و ارتباط بین دانش‌آموزان و مدرسان فراهم می‌سازند.',NULL,NULL,NULL),
(4,'آرشیو کلاس آنلاین سنوات قبل','آرشیو کلاس آنلاین سنوات قبل','online_past_archives','onlineClassroomPastArchives','online_past_archives.jpg',4,1,'ابزارهای دوره‌های آموزشی ما از جمله خط سیر آموزشی، کلاس آنلاین، آرشیو کلاس آنلاین، آزمون، تکلیف، پیامگاه، ارسال و دریافت تحقیقات، و نظرسنجی، به شما امکان می‌دهند تا به راحتی به منابع آموزشی دسترسی پیدا کنید، در کلاس‌های زنده شرکت کنید، و تکالیف خود را ارسال و ارزیابی کنید. این ابزارها با هدف ارتقای تجربه آموزشی شما طراحی شده‌اند و امکانات مختلفی را برای بهبود یادگیری و ارتباط بین دانش‌آموزان و مدرسان فراهم می‌سازند.',NULL,NULL,NULL),
(5,'آزمون','آزمون','quiz','quiz','quiz.jpg',5,1,'ابزارهای دوره‌های آموزشی ما از جمله خط سیر آموزشی، کلاس آنلاین، آرشیو کلاس آنلاین، آزمون، تکلیف، پیامگاه، ارسال و دریافت تحقیقات، و نظرسنجی، به شما امکان می‌دهند تا به راحتی به منابع آموزشی دسترسی پیدا کنید، در کلاس‌های زنده شرکت کنید، و تکالیف خود را ارسال و ارزیابی کنید. این ابزارها با هدف ارتقای تجربه آموزشی شما طراحی شده‌اند و امکانات مختلفی را برای بهبود یادگیری و ارتباط بین دانش‌آموزان و مدرسان فراهم می‌سازند.',NULL,NULL,NULL),
(6,'تکلیف','تکلیف','assignments','assignment','assignment.jpg',6,1,'ابزارهای دوره‌های آموزشی ما از جمله خط سیر آموزشی، کلاس آنلاین، آرشیو کلاس آنلاین، آزمون، تکلیف، پیامگاه، ارسال و دریافت تحقیقات، و نظرسنجی، به شما امکان می‌دهند تا به راحتی به منابع آموزشی دسترسی پیدا کنید، در کلاس‌های زنده شرکت کنید، و تکالیف خود را ارسال و ارزیابی کنید. این ابزارها با هدف ارتقای تجربه آموزشی شما طراحی شده‌اند و امکانات مختلفی را برای بهبود یادگیری و ارتباط بین دانش‌آموزان و مدرسان فراهم می‌سازند.',NULL,NULL,NULL),
(7,'پیامگاه','پیامگاه','forum','forum','forum.jpg',7,1,'ابزارهای دوره‌های آموزشی ما از جمله خط سیر آموزشی، کلاس آنلاین، آرشیو کلاس آنلاین، آزمون، تکلیف، پیامگاه، ارسال و دریافت تحقیقات، و نظرسنجی، به شما امکان می‌دهند تا به راحتی به منابع آموزشی دسترسی پیدا کنید، در کلاس‌های زنده شرکت کنید، و تکالیف خود را ارسال و ارزیابی کنید. این ابزارها با هدف ارتقای تجربه آموزشی شما طراحی شده‌اند و امکانات مختلفی را برای بهبود یادگیری و ارتباط بین دانش‌آموزان و مدرسان فراهم می‌سازند.',NULL,NULL,NULL),
(8,'ارسال و دریافت تحقیقات','ارسال و دریافت تحقیقات','inbox','inbox','message_box.jpg',8,0,'ابزارهای دوره‌های آموزشی ما از جمله خط سیر آموزشی، کلاس آنلاین، آرشیو کلاس آنلاین، آزمون، تکلیف، پیامگاه، ارسال و دریافت تحقیقات، و نظرسنجی، به شما امکان می‌دهند تا به راحتی به منابع آموزشی دسترسی پیدا کنید، در کلاس‌های زنده شرکت کنید، و تکالیف خود را ارسال و ارزیابی کنید. این ابزارها با هدف ارتقای تجربه آموزشی شما طراحی شده‌اند و امکانات مختلفی را برای بهبود یادگیری و ارتباط بین دانش‌آموزان و مدرسان فراهم می‌سازند.',NULL,NULL,'2024-09-09 10:32:59'),
(9,'نظرسنجی','نظرسنجی','survey','survey','survey.jpg',9,1,'ابزارهای دوره‌های آموزشی ما از جمله خط سیر آموزشی، کلاس آنلاین، آرشیو کلاس آنلاین، آزمون، تکلیف، پیامگاه، ارسال و دریافت تحقیقات، و نظرسنجی، به شما امکان می‌دهند تا به راحتی به منابع آموزشی دسترسی پیدا کنید، در کلاس‌های زنده شرکت کنید، و تکالیف خود را ارسال و ارزیابی کنید. این ابزارها با هدف ارتقای تجربه آموزشی شما طراحی شده‌اند و امکانات مختلفی را برای بهبود یادگیری و ارتباط بین دانش‌آموزان و مدرسان فراهم می‌سازند.',NULL,NULL,NULL);
...
(1,'استاد','استاد','teacher',1,NULL,'2024-07-06 20:22:33','2024-07-06 20:22:33'),
(2,'دانشجو','دانشجو','student',1,NULL,'2024-07-06 20:22:33','2024-07-06 20:22:33'),
(3,'دستیار استاد','دستیار استاد','Assistant',1,NULL,'2024-07-06 20:22:33','2024-07-06 20:22:33'),
(4,'پرسنل','پرسنل','personel',1,NULL,'2024-07-06 20:22:33','2024-07-06 20:22:33'),
(5,'کارشناس آموزش','کارشناس آموزش','education expert',1,NULL,'2024-07-06 20:22:33','2024-07-06 20:22:33'),
(6,'کارشناس برگزاری کلاس آنلاین','کارشناس برگزاری کلاس آنلاین','Online class expert',1,NULL,'2024-07-06 20:22:33','2024-07-06 20:22:33'),
(7,'کارشناس انفورماتیک','کارشناس انفورماتیک','Informatics expert',1,NULL,'2024-07-06 20:22:33','2024-07-06 20:22:33'),
(8,'کارشناس امتحانات','کارشناس امتحانات','exam',1,NULL,NULL,NULL),
(9,'کارشناس پژوهش','کارشناس پژوهش','Research expert',1,NULL,'2024-09-16 13:38:39','2024-09-16 13:38:39'),
(10,'کارشناس آموزش های آزاد','کارشناس آموزش های آزاد',NULL,1,NULL,'2024-10-07 19:55:34','2024-10-07 19:55:34');
