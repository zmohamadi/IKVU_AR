...
export function Page({ laraPath, course, nextPath = "" }) {
    const { Lang } = useLang();
    ...
    useEffect(() => {
        if (group > 0) {
            ...
            get(`${laraPath}/onlineClassroomPastArchives/${course}/${group}`, component, "info", (data) => {
                setArchives(data); // Set fetched data to state using the callback
