    ...
    return (
        <div className="col-span-12 lg:col-span-6 mt-6">
            <div className="ads-box box p-8 relative overflow-hidden intro-y">
                <div className="ads-box__title w-full sm:w-52 text-theme-17 dark:text-white text-xl -mt-3">{data?.title}</div>
                ...
                <Pic src={`${mediaPath}/courses/${data?.thumbnail}`} classImg="hidden sm:block absolute top-0 left-0 w-1/2 mb-1 -ml-12" defaultImg={`${mediaPath}/public/default/course.jpg`} key={"img"+data?.thumbnail} />
